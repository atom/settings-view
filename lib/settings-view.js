...
export default class SettingsView {
  ...
  initializePanels () {
    ...
    this.refs.openDotAtom.addEventListener('focus', focusHandler)
    this.disposables.add(new Disposable(() => this.refs.openDotAtom.removeEventListener('focus', focusHandler)))
