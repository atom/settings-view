...
export default class GeneralPanel {
  constructor () {
    ...
    this.refs.loadingElement.remove()
    ...
    return (
      <div tabIndex='0' className='panels-item'>
        <form className='general-panel section'>
          <div ref='loadingElement' className='alert alert-info loading-area icon icon-hourglass'>Loading settings</div>
        </form>
      </div>
    )
  }
